...
- **240+ atendimentos** lançados de ponta a ponta pelo robô (80 de uma unidade + 160 de outra).
- Meta de **120 horas** de atendimento cumprida — com o trabalho manual reduzido de horas a minutos.
- **~40 segundos por lançamento**, sem supervisão, contra vários minutos cada um à mão.
- **Nenhuma senha** manipulada pelo robô e **nenhum dado pessoal** versionado.
